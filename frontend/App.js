...
function App() {
  ...
  return(
    ...
    <Routes>
      ...
      <Route path='/workshops' exact element={<Category setToken={setToken} token={token} endpoint={"http://localhost:3000/api/event/category/workshop"} category={"Workshops"}  />} /> 
      <Route path='/seminars' exact element={<Category setToken={setToken} token={token} endpoint={"http://localhost:3000/api/event/category/seminar"} category={"Seminars"}  />} /> 
      <Route path='/symposium' exact element={<Category setToken={setToken} token={token} endpoint={"http://localhost:3000/api/event/category/symposium"} category={"Symposiums"}  />} /> 
    </Routes>
    </div>
  );
}
