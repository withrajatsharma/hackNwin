...
<div class="text-serif px-10 ">
        ...
        <p class="font-serif font-extrabold text-5xl text-center ">Amal</p>
          ...
          <div className="flex items-center flex-wrap mb-20">
            <div className="w-full md:w-1/2 pr-10">
              <h4 className="text-3xl text-gray-800 font-bold mb-3 text-serif">Explore the World of Opportunities and Grab the Success.</h4>
              <p className="text-gray-600 mb-8 text-serif">
                AMAL is an in all-in-one platform for both hosts and participants.<br />
                It provides learning and development opportunities for students. It is internship and placements providing platform. It is also provides career paths and advices.
                It empowers everyone to access information about all the career oriented activities going around in the world and in the country.
                Connect with the world and share your knowledge we have got everything covered!!
          ...
          <div className="flex items-center flex-wrap mb-20">
            ...
            <div className="w-full md:w-1/2 pl-10">
              <h4 className="text-3xl text-gray-800 font-bold mb-3">Use the Force!</h4>
              <p className="text-gray-600 mb-8">
                Now with AMAL its even easier to manage the events!!, Your participants are just one click away from getting their certificates.
                Hosts can even take registrations and connect with their participants through one common portal.
              </p>
            </div>
          </div>
          <div className="flex items-center flex-wrap mb-20">
            <div className="w-full md:w-1/2 pr-10">
              <h4 className="text-3xl text-gray-800 font-bold mb-3">Life creates it</h4>
              <p className="text-gray-600 mb-8">
                Connect with your friends and let them know what workshops, seminars or Symposiums your are attending these days,
              </p>
            </div>
            <div className="w-full md:w-1/2">
              <img className="rounded-lg" src="https://i.ibb.co/6PSbdLP/undraw-A-day-off-re-hedl.png" alt="Syncing" />
      ...
      <section className="bg-[#676ECC]">
          <div className="container mx-auto px-6 text-center py-20">
            <h2 className="mb-6 text-4xl font-bold text-center text-white">Contact Us</h2>
            <h3 className="my-4 text-xl text-white font-serif">Feel free to reach out to us about anything.</h3>
            <h3 className="my-4 text-xl text-white font-serif">Drop in your email address, we will try to reach you ASAP!</h3>
            <input 
                type="text" 
                placeholder="E-mail"
                className="text-2xl font-bold py-2 px-8 rounded-full mr-5 shadow-lg"
            />
            <button className="bg-white font-bold rounded-full py-4 px-8 shadow-lg hover:border-blue hover:text-white hover:bg-[#1d1a53]">Report</button>
          </div>
        </section>
    </>);
}
